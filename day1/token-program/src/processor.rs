    ...
    pub fn process_instruction(
        ...
        match instruction {
            TokenInstruction::CreateToken => {
                ...
                let token_master_account = next_account_info(accounts_iter)?; // new account to create a token for
                let token_authority = next_account_info(accounts_iter)?; // account that acts as an owner og the token and has authority to do things like mint new tokens
